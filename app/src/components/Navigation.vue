    ...
    <nav class="container-fluid bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
          <li class="nav-item">
            <a class="nav-link py-2 px-0 px-lg-2" href="https://github.com/k0etsu/xivodreview" target="_blank">{{ msg }}</a>
          </li>
        </ul>
      ...
      <!-- <div class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1" data-bs-scroll="true">
        <div class="offcanvas-body p-4 pt-0 p-lg-0">
          <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
            <li class="nav-item col-6 col-lg-auto">
              <h5 class="navbar-brand py-2 px-0 px-lg-2 active">xivodreview</h5>
            </li>
            <li class="nav-item col-6 col-lg-auto">
              <a class="nav-link py-2 px-0 px-lg-2" href="https://github.com/k0etsu/xivodreview" target="_blank">{{ msg }}</a>
            </li>
